...
const Navbar = ({ scrollToSection, sectionIds = ['hero-section', 'about-section', 'skills-section', 'projects-section', 'contact-section'] }) => {
                    ...
                    <ul className="nav-menu">
                        ...
                        <li className="nav-item">
                            <a
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    handleNavClick(1, 'about-section');
                                }}
                                data-tooltip="About"
                            >
                        ...
                        <li className="nav-item">
                            <a
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    handleNavClick(2, 'skills-section');
                                }}
                                data-tooltip="Skills"
                            >
                        ...
                        <li className="nav-item">
                            <a
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    handleNavClick(3, 'projects-section');
                                }}
